...
export class Migration1758979999469 implements MigrationInterface {
    name = 'Migration1758979999469'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`account_number\` \`account_number\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`account_name\` \`account_name\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`bank_code\` \`bank_code\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`bank_name\` \`bank_name\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`company_phone\` \`company_phone\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`company_email\` \`company_email\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`company_address\` \`company_address\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`theme_color\` \`theme_color\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`template_name\` \`template_name\` varchar(255) NOT NULL`);
