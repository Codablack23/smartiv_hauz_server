...
export class Migration1761116063874 implements MigrationInterface {
    name = 'Migration1761116063874'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`customers\` DROP COLUMN \`source\``);
        await queryRunner.query(`ALTER TABLE \`customers\` DROP COLUMN \`services\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customers\` ADD \`services\` longtext NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`customers\` ADD \`source\` enum ('PROMOTIONS', 'OFFERS', 'TOOLS') NOT NULL DEFAULT ''TOOLS''`);
    }
