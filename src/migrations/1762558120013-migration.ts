...
export class Migration1762558120013 implements MigrationInterface {
    name = 'Migration1762558120013'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`type\` enum ('INVOICE', 'RECEIPT') NOT NULL DEFAULT 'INVOICE'`);
