...
export class Migration1762385311597 implements MigrationInterface {
    name = 'Migration1762385311597'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`promotions\` CHANGE \`promotion_type\` \`promotion_type\` enum ('WEB_DEVELOPMENT', 'APP_DEVELOPMENT', 'DIGITAL_MARKETING', 'CONTENT_CREATION', 'BRANDING', 'TRANING_AND_DEVELOPMENT') NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`projects\` CHANGE \`project_type\` \`project_type\` enum ('WEB_DEVELOPMENT', 'APP_DEVELOPMENT', 'DIGITAL_MARKETING', 'CONTENT_CREATION', 'BRANDING', 'TRANING_AND_DEVELOPMENT') NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`projects\` CHANGE \`project_type\` \`project_type\` enum ('WEB_DEVELOPMENT', 'APP_DEVELOPMENT', 'DIGITAL_MARKETING', 'SOCIAL_MEDIA_MARKETING', 'BRAND_IDENTITY_DESIGN') NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`promotions\` CHANGE \`promotion_type\` \`promotion_type\` enum ('WEB_DEVELOPMENT', 'APP_DEVELOPMENT', 'DIGITAL_MARKETING', 'SOCIAL_MEDIA_MARKETING', 'BRAND_IDENTITY_DESIGN') NOT NULL`);
