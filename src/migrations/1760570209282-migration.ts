...
export class Migration1760570209282 implements MigrationInterface {
    name = 'Migration1760570209282'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_03a835d4287e004f1070baf5fa\` ON \`quotes\` (\`name\`)`);
    }
