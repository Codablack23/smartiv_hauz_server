...
export class Migration1757411747740 implements MigrationInterface {
    name = 'Migration1757411747740'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`articles\` ADD \`author\` longtext NULL DEFAULT 'NULL'`);
    }
