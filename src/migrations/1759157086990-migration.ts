...
export class Migration1759157086990 implements MigrationInterface {
    name = 'Migration1759157086990'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`customer_tokens\` (\`id\` varchar(36) NOT NULL, \`expires_at\` timestamp NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`customerId\` varchar(36) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`customer_tokens\` ADD CONSTRAINT \`FK_5d30a523543c0372c9711f8bce9\` FOREIGN KEY (\`customerId\`) REFERENCES \`customers\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`customer_tokens\` DROP FOREIGN KEY \`FK_5d30a523543c0372c9711f8bce9\``);
        await queryRunner.query(`ALTER TABLE \`invoice_notes\` DROP FOREIGN KEY \`FK_ac5555e18a06f4e99c0ebb3c4e5\``);
        await queryRunner.query(`ALTER TABLE \`invoice_addons\` DROP FOREIGN KEY \`FK_6930b2a893031cee4bd54d34e60\``);
        await queryRunner.query(`ALTER TABLE \`invoice_products\` DROP FOREIGN KEY \`FK_881e262323b57e3bd6446782f4d\``);
        await queryRunner.query(`ALTER TABLE \`projects\` DROP FOREIGN KEY \`FK_091f9433895a53408cb8ae3864f\``);
