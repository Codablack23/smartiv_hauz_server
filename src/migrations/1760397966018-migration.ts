...
export class Migration1760397966018 implements MigrationInterface {
    name = 'Migration1760397966018'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`promotions\` ADD \`content\` longtext NOT NULL DEFAULT '<p></p>'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`promotions\` DROP COLUMN \`content\``);
    }
