...
export class Migration1758979474978 implements MigrationInterface {
    name = 'Migration1758979474978'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`template_name\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`theme_color\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`company_address\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`company_email\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`company_phone\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`bank_name\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`bank_code\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`account_name\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`account_number\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`articles\` ADD CONSTRAINT \`FK_65d9ccc1b02f4d904e90bd76a34\` FOREIGN KEY (\`authorId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`account_number\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`account_name\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`bank_code\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`bank_name\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`company_phone\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`company_email\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`company_address\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`theme_color\``);
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`template_name\``);
    }
