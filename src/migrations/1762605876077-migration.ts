...
export class Migration1762605876077 implements MigrationInterface {
    name = 'Migration1762605876077'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`tax\` decimal NULL`);
