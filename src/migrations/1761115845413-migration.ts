...
export class Migration1761115845413 implements MigrationInterface {
    name = 'Migration1761115845413'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`customers\` ADD \`services\` longtext NULL`);
