...
export class Migration1759312649586 implements MigrationInterface {
    name = 'Migration1759312649586'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customers\` ADD UNIQUE INDEX \`IDX_8536b8b85c06969f84f0c098b0\` (\`email\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customers\` DROP INDEX \`IDX_8536b8b85c06969f84f0c098b0\``);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_8c7ce9f4395ca96dc398e54c31\` ON \`customers\` (\`company_name\`)`);
    }
