...
export class Migration1757537956000 implements MigrationInterface {
    name = 'Migration1757537956000'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`projects\` ADD \`banner\` longtext NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`projects\` DROP COLUMN \`banner\``);
    }
