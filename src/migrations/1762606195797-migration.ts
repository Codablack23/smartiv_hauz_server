...
export class Migration1762606195797 implements MigrationInterface {
    name = 'Migration1762606195797'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`invoices\` ADD \`tax_type\` text NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`due_amount\` \`due_amount\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`tax\` \`tax\` decimal NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`tax\` \`tax\` decimal(10,0) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`invoices\` CHANGE \`due_amount\` \`due_amount\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`invoices\` DROP COLUMN \`tax_type\``);
    }
