...
export class Migration1761117737277 implements MigrationInterface {
    name = 'Migration1761117737277'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`leads\` (\`id\` varchar(36) NOT NULL, \`company_name\` longtext NOT NULL, \`email\` longtext NOT NULL, \`name\` longtext NOT NULL, \`services\` json NULL, \`source\` enum ('PROMOTIONS', 'OFFERS') NOT NULL DEFAULT 'PROMOTIONS', \`phone_number\` longtext NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`offerId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
