...
export class Migration1760564682022 implements MigrationInterface {
    name = 'Migration1760564682022'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`quotes\` ADD \`company_name\` longtext NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`quotes\` DROP COLUMN \`company_name\``);
    }
